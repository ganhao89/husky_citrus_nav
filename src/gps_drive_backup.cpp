...
#include <tf/transform_broadcaster.h>
	...
	double x_current_ = 0.0;
	double y_current_ = 0.0;
	double x_waypoint_ = 0.0;
	double y_waypoint_ = 0.0;
	double heading_current_ = 0.0;
	double heading_waypoint_ = 0.0;
...
int main(int argc, char **argv)
{
  ...
  while (ros::ok())
  {
     ...
     ros::Subscriber robot_waypoint=sub_odo.subscribe("/waypoint",1,waypointCallback);
     ros::spinOnce();
     driver.publishSpeed();
     r.sleep();
  }
